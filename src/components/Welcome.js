      ...
      <MediaQuery query='(min-device-width: 750px)'>
        ...
        <MediaQuery query='(max-device-width: 749px)'>
          <div className="Welcome">
            <h1 id="opener">Workday Weather</h1>
            <br></br>
            <Link to={'/weather'} className="weatherLink"><FlatButton label="click here to get the forecast for the working hours of 9am-6pm" secondary={true} backgroundColor={'rgba(255,255,255,0.5)'} hoverColor={'rgba(255,255,255,1)'} rippleColor={'#AE3CB4'} /></Link>
          </div>
          <div className="intro">
            <div id="umbrella" className="explain">
              <img className="icon" alt="umbrella" src={'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Keepdry.svg/300px-Keepdry.svg.png'} />
